...
const prompts = {
  ...
  trainingData: {
    response: "Dữ liệu huấn luyện của mình được cập nhật đến tháng 4 năm 2025. Đây là thời điểm cutoff của kiến thức mà mình có. Nếu bạn cần thông tin sau thời điểm này hoặc về các sự kiện đang diễn ra, mình có thể tìm kiếm thông tin mới nhất để hỗ trợ bạn! 😊",
